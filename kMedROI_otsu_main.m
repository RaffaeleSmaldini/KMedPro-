...
model_params.nclusters = 2; % clusters for otsu algorithm to segment the final mask
...
heuristic_params.weightSpatial = 5;  % penalize clusters distant from center (since is a centered ROI image)
% otherwise use:
